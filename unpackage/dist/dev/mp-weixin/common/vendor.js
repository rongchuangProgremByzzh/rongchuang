...
var appid = "wxead2ae5bf7837720";var _default =
{
  ...
  info: function info(res, sessionKey, token) {
    var param = "sessionKey=".concat(sessionKey, "&signature=").concat(res.signature, "&\n\t\trawData=").concat(
    res.rawData, "&encryptedData=").concat(res.encryptedData, "&iv=").concat(res.iv, "&Authorization=").concat(token);
